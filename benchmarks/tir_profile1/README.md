...
Thermal public py2sess benchmark scene. Run from the repository root:
...
`reference_outputs.npz` includes `wavelength_nm`, `wavenumber_cm_inv`,
`wavenumber_band_cm_inv`, `ref_2s`, `ref_fo`, and `ref_total`.
